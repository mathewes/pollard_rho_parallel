...
{"Mod",0,(void*)gmodulo,2,"GG","Mod(x,y): creates 'x modulo y'."},
...
{"Vecrev",0,(void*)gtovecrev,2,"DG","Vecrev({x=[]}): transforms the object x into a vector. Empty vector if x is omitted."},
...
{"_=_",0,(void*)gstore,13,"m&G","x=y: store value y in variable x."},
...
{"bestappr",0,(void*)bestappr0,4,"GDGDG","bestappr(x, {A},{B}): if x is real, gives the best approximation to x with denominator less or equal to A. If x is an intmod, returns a rational number congruent to x with numerator less than A and denominator less than B, which must be given. If x is a polmod, returns a rational functions congruent to x with numerator degree less than A and denominator degree less than B, which must be given.  Otherwise applies recursively to all components."},
{"bezout",0,(void*)vecbezout,4,"GG","bezout(x,y): returns [u,v,d] such that d=gcd(x,y) and u*x+v*y=d."},
{"bezoutres",0,(void*)vecbezoutres,4,"GG","bezoutres(x,y): gives a 3-dimensional row vector [u,v,d] such that d=resultant(x,y) and u*x+v*y=d, where x and y are polynomials."},
{"bigomega",0,(void*)gbigomega,4,"G","bigomega(x): number of prime divisors of x, counted with multiplicity."},
...
{"contfracpnqn",0,(void*)pnqn,4,"G","contfracpnqn(x): [p_n,p_{n-1}; q_n,q_{n-1}] corresponding to the continued fraction x."},
...
{"elladd",0,(void*)addell,5,"GGG","elladd(E,z1,z2): sum of the points z1 and z2 on elliptic curve E."},
{"ellak",0,(void*)akell,5,"GG","ellak(E,n): computes the n-th Fourier coefficient of the L-function of the elliptic curve E (assumed E is a minimal model)."},
...
{"ellap",0,(void*)ellap,5,"GDG","ellap(E,{p}): computes a_p for the elliptic curve E using Shanks-Mestre's method, or SEA algorithm if the package seadata is installed. Assume the equation is minimal at p."},
...
{"ellgenerators",0,(void*)ellgenerators,5,"G","ellgenerators(E): if E is an elliptic curve as output by ellinit(), return the generators of the Mordell-Weil group associated to the curve. This function depends on the curve being referenced in the elldata database."},
{"ellglobalred",0,(void*)ellglobalred,5,"G","ellglobalred(E): E being an elliptic curve, returns [N,[u,r,s,t],c], where N is the conductor of E, [u,r,s,t] leads to the standard model for E, and c is the product of the local Tamagawa numbers c_p."},
{"ellgroup",0,(void*)ellgroup,5,"GDG","ellgroup(E,{p}): computes the structure of the group E(Fp) Assume the equation is minimal at p."},
{"ellheight",0,(void*)ellheight0,5,"GGD2,L,p","ellheight(E,x,{flag=2}): canonical height of point x on elliptic curve E (assumed to be a minimal model). flag is optional and selects the algorithm used to compute the Archimedean local height. Its meaning is 0: use theta-functions, 1: use Tate's method, 2: use Mestre's AGM."},
...
{"ellidentify",0,(void*)ellidentify,5,"G","ellidentify(E): look up the elliptic curve E in the elldata database and return [[N, M, ...], C] where N is the name of the curve in J. E. Cremona database, M the minimal model and C the coordinates change (see ellchangecurve)."},
...
{"ellmodulareqn",0,(void*)ellmodulareqn,5,"LDnDn","ellmodulareqn(l,{x},{y}): return a vector [eqn, t] where eqn is a modular equation of level l, for l<500, l prime. This requires the package seadata to be installed.  The equation is either of canonical type (t=0) or of Atkin type (t=1)"},
{"ellorder",0,(void*)ellorder,5,"GGDG","ellorder(E,z,{o}): order of the point z on the elliptic curve E over Q or a finite field, 0 if non-torsion. The parameter o, if present, represents a non-zero multiple of the order of z (mandatory over non-prime finite fields)."},
...
{"ellpow",0,(void*)powell,5,"GGG","ellpow(E,z,n): n times the point z on elliptic curve E (n in Z)."},
...
{"ellsearch",0,(void*)ellsearch,5,"G","ellsearch(N): if N is an integer, it is taken as a conductor else if N is a string, it can be a curve name (\"11a1\"), a isogeny class (\"11a\") or a conductor (\"11\"). Return all curves in the elldata database that match the property."},
{"ellsigma",0,(void*)ellsigma,5,"GGD0,L,p","ellsigma(E,z,{flag=0}): E being given by ellinit, returns the value of the Weierstrass sigma function of the lattice generated by om at z if flag = 0 (default). If flag = 1, arbitrary determination of the logarithm of sigma. If flag = 2 or 3, same but using the product expansion instead of theta series."},
{"ellsub",0,(void*)subell,5,"GGG","ellsub(E,z1,z2): difference of the points z1 and z2 on elliptic curve E."},
{"elltaniyama",0,(void*)elltaniyama,5,"GDP","elltaniyama(E, {d = seriesprecision}): modular parametrization of elliptic curve E (minimal model)."},
...
{"ellwp",0,(void*)ellwp0,5,"GDGD0,L,DPp","ellwp(E,{z=x},{flag=0},{d=seriesprecision}): computes the value at z of the Weierstrass P function attached to the elliptic curve E as given by ellinit (alternatively, E can be given as a lattice [om1,om2]). Optional flag means 0 (default), compute only P(z), 1 compute [P(z),P'(z)], 2 consider om as an elliptic curve and compute P(z) for that curve (identical to ellztopoint in that case). If z is omitted or is a simple variable, return formal expansion in z with d significant terms."},
{"ellzeta",0,(void*)ellzeta,5,"GGp","ellzeta(E,z): E being given by ellinit, returns the value at z of the Weierstrass zeta function of the period lattice of E."},
...
{"eulerphi",0,(void*)geulerphi,4,"G","eulerphi(x): Euler's totient function of x."},
...
{"factor",0,(void*)gp_factor0,4,"GDG","factor(x,{lim}): factorization of x. lim is optional and can be set whenever x is of (possibly recursive) rational type. If lim is set return partial factorization, using primes < lim (up to primelimit if lim=0)."},
...
{"factorpadic",0,(void*)factorpadic0,7,"GGLD0,L,","factorpadic(pol,p,r,{flag=0}): p-adic factorization of the polynomial pol to precision r. flag is optional and may be set to 0 (use round 4) or 1 (use Buchmann-Lenstra)."},
{"ffgen",0,(void*)ffgen,4,"GDn","ffgen(P,{v}): return the generator g=X mod P(X) of the finite field defined by the polynomial P(X). If v is given, the variable name is used to display g, else the variable of the polynomial P is used."},
...
{"forprime",0,(void*)forprime,11,"vV=GGI","forprime(X=a,b,seq): the sequence is evaluated, X running over the primes between a and b."},
...
{"forsubgroup",0,(void*)forsubgroup0,11,"vV=GDGI","forsubgroup(H=G,{bound},seq): execute seq for each subgroup H of the abelian group G (in SNF form), whose index is bounded by bound. H is given as a left divisor of G in HNF form."},
...
{"gamma",0,(void*)ggamma,3,"Gp","gamma(s): gamma function at x, s a complex or p-adic number."},
...
{"idealhnf",0,(void*)idealhnf0,6,"GGDG","idealhnf(nf,a,{b}): hermite normal form of the ideal a in the number field nf. If called as idealhnf(nf,a,b), the ideal is given as aZ_K+bZ_K in the number field K defined by nf."},
...
{"isfundamental",0,(void*)gisfundamental,4,"G","isfundamental(x): true(1) if x is a fundamental discriminant (including 1), false(0) if not."},
...
{"issquare",0,(void*)gissquareall,4,"GD&","issquare(x,{&n}): true(1) if x is a square, false(0) if not. If n is given puts the exact square root there if it was computed."},
{"issquarefree",0,(void*)gissquarefree,4,"G","issquarefree(x): true(1) if x is squarefree, false(0) if not."},
{"kill",0,(void*)kill0,11,"vr","kill(sym): restores the symbol sym to its ``undefined'' status and kill associated help messages."},
{"kronecker",0,(void*)gkronecker,4,"GG","kronecker(x,y): kronecker symbol (x/y)."},
...
{"lift",0,(void*)lift0,2,"GDn","lift(x,{v}): lifts every element of Z/nZ to Z or T[x]/PT[x] to T[x] for a type T if v is omitted, otherwise lift only polmods with main variable v. If v does not occur in x, lift only intmods."},
{"lindep",0,(void*)lindep0,8,"GD0,L,","lindep(x,{flag=0}): Z-linear dependencies between components of x. flag is optional, and can be 0: default, uses a standard LLL; -1: uses Hastad et al; -2: returns a non-trivial kernel vector (not integral in general); -3: uses PSLQ; or positive, using LLL with 'flag' many digits of accuracy, which should be less than the input accuracy."},
...
{"matadjoint",0,(void*)matadjoint0,8,"GD0,L,","matadjoint(x,{flag=0}): adjoint matrix of x. If flag is 0 or omitted, n! must be invertible, where n is the dimension of the matrix. If flag is 1, uses a slower division-free algorithm."},
...
{"matdetint",0,(void*)detint,8,"G","matdetint(x): some multiple of the determinant of the lattice generated by the columns of x (0 if not of maximal rank). Useful with mathnfmod."},
...
{"mathnfmodid",0,(void*)hnfmodid,8,"GG","mathnfmodid(x,d): (upper triangular) Hermite normal form of x concatenated with d times the identity matrix."},
...
{"matsolve",0,(void*)gauss,8,"GG","matsolve(M,B): Gaussian solution of MX=B (M matrix, B column vector)."},
...
{"moebius",0,(void*)gmoebius,4,"G","moebius(x): Moebius function of x."},
...
{"nextprime",0,(void*)gnextprime,4,"G","nextprime(x): smallest pseudoprime >= x."},
...
{"nfdisc",0,(void*)nfdisc0,6,"GD0,L,DG","nfdisc(x,{flag=0},{fa}): discriminant of the number field defined by the polynomial x using round 4. Optional args flag and fa are as in nfbasis."},
...
{"nffactor",0,(void*)nffactor,6,"GG","nffactor(nf,x): factor polynomial x in number field nf."},
...
{"nffactormod",0,(void*)nffactormod,6,"GGG","nffactormod(nf,pol,pr): factorize polynomial pol modulo prime ideal pr in number field nf."},
...
{"nfsolvemodpr",0,(void*)nfsolvemodpr,6,"GGGG","nfsolvemodpr(nf,a,b,pr): solution of a*x=b in Z_K/pr, where a is a matrix and b a column vector, and where pr is in modpr format (see nfmodprinit)."},
...
{"norml2",0,(void*)gnorml2,2,"G","norml2(x): square of the L2-norm of the vector x."},
{"numbpart",0,(void*)numbpart,4,"G","numbpart(n): number of partitions of n."},
{"numdiv",0,(void*)gnumbdiv,4,"G","numdiv(x): number of divisors of x."},
...
{"omega",0,(void*)gomega,4,"G","omega(x): number of distinct prime divisors of x."},
...
{"partitions",0,(void*)partitions,4,"LD0,L,","partitions(n,{restr=0}): return vector of partitions of n, a positive integer. The second optional argument may be set to a number smaller than n to restrict the value of each element in the partitions to that value. The default of 0 means that this maximum is n itself."},
...
{"polisirreducible",0,(void*)gisirreducible,7,"G","polisirreducible(pol): true(1) if pol is an irreducible non-constant polynomial, false(0) if pol is reducible or constant."},
...
{"polred",0,(void*)polred0,6,"GD0,L,DG","polred(x,{flag=0},{fa}): reduction of the polynomial x (gives minimal polynomials only). Second and third args are optional. The following binary digits of flag are significant 1: partial reduction, 2: gives also elements. fa, if present, contains the factorization matrix of the discriminant."},
{"polredabs",0,(void*)polredabs0,6,"GD0,L,","polredabs(T,{flag=0}): a smallest generating polynomial of the number field for the T2 norm on the roots, with smallest index for the minimal T2 norm. flag is optional, whose binary digit mean 1: give the element whose characteristic polynomial is the given polynomial. 4: give all polynomials of minimal T2 norm (give only one of P(x) and P(-x)). 16: partial reduction."},
{"polredord",0,(void*)ordred,6,"G","polredord(x): reduction of the polynomial x, staying in the same order."},
...
{"poltchebi",0,(void*)polchebyshev1,7,"LDn","poltchebi(n,{v=x}): Tchebitcheff polynomial of degree n, in variable v. (For backward compatibility.)"},
...
{"precision",0,(void*)precision0,2,"GD0,L,","precision(x,{n}): change the precision of x to be n. If n is omitted, output real precision of object x."},
{"precprime",0,(void*)gprecprime,4,"G","precprime(x): largest pseudoprime <= x, 0 if x<=1."},
...
{"primes",0,(void*)primes,4,"L","primes(x): returns the vector of the first x primes."},
...
{"qfrep",0,(void*)qfrep0,8,"GGD0,L,","qfrep(q,B,{flag=0}): vector of (half) the number of vectors of norms from 1 to B for the integral and definite quadratic form q. Binary digits of flag mean 1: count vectors of even norm from 1 to 2B, 2: return a t_VECSMALL instead of a t_VEC."},
...
{"rnfeltabstorel",0,(void*)rnfelementabstorel,6,"GG","rnfeltabstorel(rnf,x): transforms the element x from absolute to relative representation."},
{"rnfeltdown",0,(void*)rnfelementdown,6,"GG","rnfeltdown(rnf,x): expresses x on the base field if possible; returns an error otherwise."},
{"rnfeltreltoabs",0,(void*)rnfelementreltoabs,6,"GG","rnfeltreltoabs(rnf,x): transforms the element x from relative to absolute representation."},
{"rnfeltup",0,(void*)rnfelementup,6,"GG","rnfeltup(rnf,x): expresses x (belonging to the base field) on the relative field."},
...
{"rnfidealhnf",0,(void*)rnfidealhermite,6,"GG","rnfidealhnf(rnf,x): relative version of idealhnf, where rnf is a relative numberfield."},
...
{"rnfinit",0,(void*)rnfinit,6,"GG","rnfinit(nf,pol): pol being a non constant irreducible polynomial defined over the number field nf, initializes a vector of data necessary for working in relative number fields (rnf functions). See manual for technical details."},
...
{"select",0,(void*)select0,11,"GG","select(f, A): selects elements of A according to the selection function f."},
...
{"serreverse",0,(void*)recip,7,"G","serreverse(x): reversion of the power series x."},
...
{"setsearch",0,(void*)setsearch,8,"lGGD0,L,","setsearch(S,x,{flag=0}): looks if x belongs to the set S. If flag is 0 or omitted, returns 0 if it is not, otherwise returns the index j such that x==S[j]. If flag is non-zero, return 0 if x belongs to S, otherwise the index j where it should be inserted."},
...
{"sqrtint",0,(void*)sqrtint,4,"G","sqrtint(x): integer square root of x (x integer)."},
...
{"sumdiv",0,(void*)divsum,9,"GVE","sumdiv(n,X,expr): sum of expression expr, X running over the divisors of n."},
...
{"trap",0,(void*)trap0,11,"DrDEDE","trap({e}, {rec}, seq): try to execute seq, trapping runtime error e (all of them if e ommitted); sequence rec is executed if the error occurs and is the result of the command."},
...
{"valuation",0,(void*)ggval,2,"lGG","valuation(x,p): valuation of x with respect to p."},
{"variable",0,(void*)gpolvar,2,"DG","variable({x}): main variable of object x. Gives p for p-adic x, error for scalars. Returns the list of user variables if x is omitted."},
...
{"znlog",0,(void*)znlog,4,"GGDG","znlog(x,g,{o}): return the discrete logarithm of x in (Z/nZ)* in base g. If present, o represents the multiplicative order of g. If no o is given, assume that g generate (Z/nZ)*."},
...
{"znprimroot",0,(void*)znprimroot0,4,"G","znprimroot(n): returns a primitive root of n when it exists."},
